...
//  int z = 0;// this is the counter for the temp hand
  ...
  switch( card ) 
    ...
    case council_room:
		useCouncil_Room(state, currentPlayer, handPos);
		return 0;
    ...
    case smithy:
		useSmithy(state, currentPlayer, handPos);
		return 0;
    ...
    case steward:
		useSteward(state, currentPlayer, handPos, choice1, choice2, choice3);
		return 0;
...
//###################################################################################
//The following 5 functions added for CS 362, Assignment #2
//###################################################################################
void useAdventurer(struct gameState *state, int currentPlayer){
...
//###################################################################################
//###################################################################################
void useSmithy(struct gameState *state, int currentPlayer, int handPos){
...
//###################################################################################
//###################################################################################
void useCouncil_Room(struct gameState *state, int currentPlayer, int handPos){
...
//###################################################################################
//###################################################################################
void useVillage(struct gameState *state, int currentPlayer, int handPos){
...
//###################################################################################
//###################################################################################
void useSteward(struct gameState *state, int currentPlayer, int handPos, int choice3, int choice2, int choice1){
