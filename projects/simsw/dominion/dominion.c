...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case feast:
      return playFeast (state, choice1, currentPlayer, temphand);
    ...
    case embargo:
      return playEmbargo(state, handPos, currentPlayer, choice1);
...
int playFeast (struct gameState *state, int choice1, int currentPlayer, int temphand[]){
